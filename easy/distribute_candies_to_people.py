...
the end) until we run out of candies.  The last person will receive all of our remaining candies (not necessarily one
...
class Solution:
    def distributeCandies(self, candies: int, num_people: int) -> List[int]:
        ...
        current_candies = 1
        person = 0
        while candies - current_candies >= 0:
            result[person] += current_candies
