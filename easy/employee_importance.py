...
value 15, 10 and 5, respectively. Then employee 1 has a data structure like [1, 15, [2]],
...
# Runtime: 156 ms, faster than 94.34% of Python3 online submissions for Employee Importance.
# Memory Usage: 13.7 MB, less than 100.00% of Python3 online submissions for Employee Importance.
class Solution:
    def getImportance(self, employees: List[Employee], id: int) -> int:
        ...
        def importance(id):
            imp = 0
            target = mapping.get(id)

            for sub_id in target.subordinates:
                imp += importance(sub_id)
            return target.importance + imp
